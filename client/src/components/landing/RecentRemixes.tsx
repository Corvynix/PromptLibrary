    ...
    return (
        <div className="py-12 px-6 border-y border-white/10">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-3">
                    {MOCK_REMIXES.map((remix, idx) => (
                        <motion.div
                            ...
                            className="border-l-2 border-white/10 bg-black/50 p-4 hover:border-l-blue-400 hover:bg-blue-950/10 transition-all cursor-pointer group relative overflow-hidden"
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-blue-400/0 to-blue-400/0 group-hover:from-blue-400/5 group-hover:to-transparent transition-all duration-500" />
                            <div className="flex items-center justify-between">
                                <div className="flex-1">
                                    <p className="text-sm">
                                        <span className="font-bold group-hover:text-blue-400 transition-colors">@{remix.user}</span>
                ...
                <button className="w-full mt-4 py-3 border-2 border-white/20 hover:border-white hover:bg-white hover:text-black transition-all text-xs font-bold tracking-widest rounded-full">
                    VIEW ALL ACTIVITY
                </button>
            </div>
        </div>
